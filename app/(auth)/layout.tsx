        ...
        <section className='auth-right-section'>
            <div className='z-10 relative lg:mt-4 lg:mb-16'>
                <blockquote className='auth-blockquote'>
                    Signalist turned my watchlist into a winning list. The allerts are spot-on, and fast more confident making moves in the market.
                </blockquote>
                <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-0.5'>
                        {[1,2,3,4,5].map((star)=>(
                            <Image src="/assets/icons/star.svg" alt='Star' width={20} height={20} className='w-5 h-5' key={star}/>
                        ))}
                    </div>
                </div>
            </div>
